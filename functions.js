...
let proxyBase = "https://dev.nocodery.com/proxy";
function proxy(url, callback){
      $.ajaxSetup({
          scriptCharset: "utf-8", //or "ISO-8859-1"
          contentType: "application/json; charset=utf-8"
      });
      // console.log(proxyBase+'?url='+encodeURIComponent(url));
      var a = $.get(proxyBase+'?url=' + encodeURIComponent(url), function(data){
